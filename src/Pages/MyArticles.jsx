            ...
            <div className="bg-base-200 p-6 rounded-lg w-full max-w-lg">
              ...
              <form onSubmit={handleUpdate}>
                <div className="mb-4">
                  ...
                  <input type="text" id="title" name="title" defaultValue={selectedArticle.title} required className="w-full px-3 py-2 border  rounded" />
                </div>
              ...
              />
                ...
                <div className="mb-4">
                  ...
                  <input type="text" id="thumbnail" name="thumbnail" defaultValue={selectedArticle.thumbnail} required className="w-full px-3 py-2 border  rounded" />
                </div>

                <div className="mb-4">
                  <label htmlFor="content" className="block mb-1">Content</label>
                  <textarea id="content" name="content" defaultValue={selectedArticle.content} required rows="4" className="w-full px-3 py-2 border  rounded"></textarea>
                </div>
